...
<aside class="sidebar" style="overflow-x: scroll;">
    <div>
        ...
        <ul class="menu">
            학생
            <li><a href="${pageContext.request.contextPath}/studentMain.co">대시보드</a></li>
           ...
           강사
            ...
            <li><a href="${pageContext.request.contextPath}/lectureCalender.co">일정관리</a></li>
            ...
            <li><a href="${pageContext.request.contextPath}/lectureFeedback.co">만족도 결과</a></li>
            <li><a href="${pageContext.request.contextPath}/notice.co">공지사항</a></li>
